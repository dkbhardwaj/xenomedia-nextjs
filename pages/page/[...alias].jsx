...
import TwoColTextAndImage from '../../components/sections/TwoColTextAndImage';
...
function pageBuilder(
    ...
    data.map((blade, index) => {
        ...
        } else if (blade.type.replace('paragraph--', '') === 'two_column_image_and_text') {
            blades.push(<TwoColTextAndImage data={blade} />);
        } else if (blade.type.replace('paragraph--', '') === 'pricing') {
            blades.push(<Pricing data={blade} />);
        }
    });
    return blades;
}
