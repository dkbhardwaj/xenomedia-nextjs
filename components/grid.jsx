...
export const ArticleGridItem = ({
	...
	return (
		<div className="container">
			...
			>
				<div className="flex flex-col rounded-lg shadow-lg overflow-hidden cursor-pointer border-2 h-full hover:border-indigo-500" style={{ width:'33.33%',margin:'0 auto' }}>
					...
					<h4 className="my-4 mx-6 text-xl leading-7 font-semibold text-gray-900">
						{article.title} &rarr;
					</h4>
				</div>
			</Link>
